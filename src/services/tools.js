...
- OPTION CHAIN DISPLAY: When fetching option chains, do NOT pass noOfStrikes unless you have a specific reason to limit results — omit it to get all available strikes. NEVER use noOfStrikes=10 — it returns too few strikes. When presenting option chain data, display ALL returned strikes in the table — do NOT cherry-pick a subset. The user needs the complete picture to make trading decisions.
